  ...
  var translations = {
    ...
    prospect: {
      en: {
        ...
        hero_sub: "Team Acquisition is a registered company in Madagascar. We align strategy, outbound execution, and market positioning to help European businesses scale with confidence.",
        ...
        j1_desc: "We map your ideal client profile and strategic priority targets.",
        j2_title: "Lead Generation Activation",
        j2_desc: "Your outreach engine is activated with premium data and messaging precision.",
        j3_title: "Strategic Sales Strike",
        j3_desc: "Focused multichannel execution converts target accounts into warm conversations.",
        j4_title: "Shared Growth & Success",
        j4_desc: "We optimize continuously to secure durable, high-quality pipeline growth.",
        sec_illus_title: "Data + Human Precision",
        sec_illus_desc: "Futuristic workflows blend data intelligence, business strategy, and trained human teams for consistent execution quality.",
      ...
      fr: {
        ...
        badge_1: "Premium",
        badge_2: "Entreprise",
        badge_3: "Strike Force Strategique",
        hero_title: "Rejoignez une Strike Force Commerciale Elite",
        hero_sub: "Team Acquisition est une entreprise enregistree a Madagascar. Nous alignons strategie, execution outbound et positionnement marche pour accelerer la croissance des entreprises europeennes.",
        hero_cta_primary: "Demarrer une discussion partenaire",
        hero_cta_secondary: "Explorer le parcours d'activation",
        journey_title: "Le Parcours d'Activation Strategique",
        j1_title: "Alignement Strategique",
        j1_desc: "Nous definissons votre client ideal et vos cibles prioritaires.",
        j2_title: "Activation Lead Generation",
        j2_desc: "Votre moteur outbound est active avec donnees premium et messages de precision.",
        j3_title: "Strategic Sales Strike",
        j3_desc: "Une execution multicanale ciblee transforme vos comptes en conversations qualifiees.",
        j4_title: "Croissance Partagee & Succes",
        j4_desc: "Nous optimisons en continu pour un pipeline durable et qualifie.",
        sec_illus_title: "Donnee + Precision Humaine",
        sec_illus_desc: "Des workflows futuristes combinent intelligence data, strategie business et equipes humaines entrainees.",
        form_title: "Candidature Partenaire",
        f_name: "Nom complet",
        f_company: "Nom de l'entreprise",
        f_email: "Email professionnel",
        f_phone: "Telephone",
        f_need: "Objectif principal",
        f_need_opt0: "Selectionner",
        f_need_opt1: "Acceleration strategique",
        f_need_opt2: "Expansion europeenne",
        f_need_opt3: "Mise en place strike force",
        f_target: "Decrivez vos clients cibles",
        f_consent_company: "Je comprends que Team Acquisition est une entreprise, pas un freelance.",
        f_consent_gdpr: "Je consens au traitement des donnees (RGPD).",
        f_submit: "Envoyer ma demande - consultation strategique",
        footer_company: "Team Acquisition | Entreprise enregistree a Madagascar"
      }
    },
    investors: {
