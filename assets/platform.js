  ...
  var translations = {
    index: {
      ...
      fr: {
        ...
        card_partner_desc: "Vous êtes une entreprise européenne ? Nous accélérons votre outbound stratégique et ouvrons des opportunités B2B exclusives.",
        card_partner_cta: "Devenir partenaire →",
        card_investor_title: "Devenir investisseur",
        card_investor_desc: "Vous cherchez un rendement accéléré et une exposition en equity sur un projet d’industrialisation structuré ?",
    ...
    investors: {
      ...
      fr: {
        ...
        hero_sub: "Team Acquisition est une entité légale enregistrée à Madagascar, ouvrant un accès investisseur structuré avec gouvernance et opérations pilotées par la data.",
        hero_cta_1: "Demander le package de due diligence",
        hero_cta_2: "Planifier un appel strategique",
        op_title: "Pourquoi cette opportunité",
        op_a: "Forte demande des opérateurs B2B européens pour une exécution de croissance efficace.",
        op_b: "Modèle industriel conçu pour la répétition, le contrôle et des résultats mesurables.",
        op_c: "Infrastructure et stratégie talent centrées sur une marge durable.",
        sec_title: "Gouvernance & Sécurité",
        sec_desc: "Gouvernance d’entreprise, documents légaux, comptabilité auditable et communication investisseur structurée.",
        form_title: "Manifestation d’intérêt investisseur",
        f_name: "Nom complet",
        f_email: "Email",
        f_phone: "Telephone",
        f_type: "Type d'investisseur",
        f_type_0: "Sélectionner",
        f_type_1: "Business Angel",
        f_type_2: "Fonds",
        f_type_3: "Family office",
        f_type_4: "Autre",
        f_amount: "Montant d’investissement",
        f_amount_0: "Sélectionner",
        f_amount_1: "24 700 EUR",
        f_amount_2: "49 400 EUR",
        f_amount_3: "Montant personnalisé",
        f_msg: "Message",
        f_consent: "Je consens au traitement des données et je comprends que Team Acquisition est une entreprise, pas un freelance.",
        f_submit: "Demander le package de due diligence",
        footer_company: "Team Acquisition | Entreprise malgache enregistrée"
      }
    },
    login: {
      en: {
